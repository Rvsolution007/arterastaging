  ...
  Widget _buildQuickStartButton(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const QuickStartWizardScreen()),
      ),
      child: Container(
      ...
      return SizedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, i) {
            ...
            final label =
                story['story_type'] ?? story['storyType'] ?? 'story'.trFormat;
            final images = <String>[];
            if (story['story_images'] is List) {
              for (var si in story['story_images']) {
                images.add(
                  si.toString().startsWith('http')
                      ? si
                      : '${hc.uploadsBaseUrl}/$si',
                );
              }
            }
            if (images.isEmpty && img.isNotEmpty) {
              images.add(
                img.startsWith('http') ? img : '${hc.uploadsBaseUrl}/$img',
              );
            }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => StoryViewer(
                        ...
                        businessLogo: hc.businessLogo.value.isNotEmpty
                            ? '${hc.uploadsBaseUrl}/${hc.businessLogo.value}'
                            : null,
                      ),
                    ),
                  );
            ...
            children: [
              Row(
                children: [
                  ...
                  AppSpacing.gapH12,
                  Text(
                    '${'upcoming_festivals'.trFormat} ${now.year}',
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: isSelected
                          ? [
                              BoxShadow(
                                color: AppColors.indigo100.withValues(
                                  alpha: 0.8,
                                ),
                                blurRadius: 12,
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: AppTextStyles.datePickerDay.copyWith(
                            color: isSelected
                                ? AppColors.indigo100
                                : AppColors.gray400,
                          ),
                        ...
                        Text(
                          ...
                          style: AppTextStyles.datePickerDate.copyWith(
                            color: isSelected
                                ? Colors.white
            ...
            if (hc.isLoading.value || hc.isFestivalLoading.value) {
              ...
              contentWidget = ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  final fullImg = imgUrl.toString().startsWith('http')
                      ? imgUrl
                      : '${hc.uploadsBaseUrl}/$imgUrl';
                  String dateStr = '';
                  try {
                    dateStr = (f['festivalDate'] ?? f['festivals_date'] ?? '')
                        .toString()
                        .split(' ')[0];
                  } catch (_) {}
      ...
      children: [
        ...
        SizedBox(
          child: Obx(() {
            ...
            if (hc.categories.isEmpty)
              return Center(
                child: Padding(
                  padding: EdgeInsets.all(32),
                  child: Text('no_categories_found'.trFormat),
                ),
              );
            return GridView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                final fullImg = img.toString().startsWith('http')
                    ? img
                    : '${hc.uploadsBaseUrl}/$img';
                return GestureDetector(
                  onTap: () => Get.toNamed(
                    '/details',
                    arguments: {
      ...
      children: [
        SectionHeader(
          ...
          onAction: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const CustomPostsScreen()),
          ),
        ),
        AppSpacing.gapV16,
        Padding(
            ...
            child: AppConfig.isProduction
                ...
                : Obx(() {
                    if (hc.customPosts.isEmpty) {
                      return Center(
                        child: Text(
                          'no_custom_posts_available'.trFormat,
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return GestureDetector(
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  CustomPostsScreen(initialCategoryId: catId),
                            ),
                          ),
                          child: Container(
                            width: 140,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              article['title'] ?? article['newsTitle'] ?? '',
                              style: TextStyle(

...
class _MoreScreenState extends State<MoreScreen> {
  ...
  Widget _buildAdLive(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        _buildSectionContainer(
          children: [
                  ...
                  Text(
                    TranslationService.availableLanguages.isEmpty
                        ...
                        : TranslationService.availableLanguages.firstWhere(
                            (l) =>
                                l['code'] == TranslationService.savedLangCode,
            ...
            SettingsItem(
              ...
              title: 'My Designs',
              subtitle: 'Restore saved Custom AI drafts',
              iconColor: AppColors.gray500,
              iconBgColor: Colors.transparent,
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const BusinessAiDraftsScreen(),
                ),
              ),
            ),
          ],
        ...
        _buildSectionContainer(
          children: [
            SettingsItem(
              ...
              onTap: () {
                ...
                Get.to(
                  () => PolicyScreen(
                    title: 'privacy_policy'.trFormat,
                    htmlContent: hc.privacyPolicyHtml.value,
                  ),
                );
              },
            ),
            SettingsItem(
              ...
              title: 'terms_conditions'.trFormat,
              iconColor: AppColors.gray500,
              iconBgColor: Colors.transparent,
              onTap: () {
                final hc = Get.find<HomeController>();
                Get.to(
                  () => PolicyScreen(
                    title: 'terms_conditions'.trFormat,
                    htmlContent: hc.termsConditionHtml.value,
                  ),
                );
              },
            ),
            SettingsItem(
              ...
              onTap: () {
                ...
                Get.to(
                  () => PolicyScreen(
                    title: 'refund_policy'.trFormat,
                    htmlContent: hc.refundPolicyHtml.value,
                  ),
                );
              },
            ),
            ...
            SettingsItem(
              ...
              onTap: () {
                ...
                if (hc.appUpdate != null) {
                  AppUpdateController.showUpdateDialogIfNeeded(
                    hc.appUpdate!,
                    isManualCheck: true,
                  );
                } else {
...
class LanguageSelectionDrawer extends StatefulWidget {
  ...
  @override
  State<LanguageSelectionDrawer> createState() =>
                            ...
                            setState(() {
                              if (isSelected) {
                                ...
                                if (selectedLanguages.length >= 5) {
                                  Get.snackbar(
                                    'limit_reached'.trFormat,
                                    'max_languages_limit'.trFormat,
                                    snackPosition: SnackPosition.BOTTOM,
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Get.snackbar(
                          'success'.trFormat,
                          'preferred_languages_updated'.trFormat,
                          snackPosition: SnackPosition.BOTTOM,

    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Add Mini Website Template</h4>
            </div>
            <div class="card-body">
                ...
                <div class="premium-ai-panel">
                    <div class="premium-ai-header">
                        ...
                        <div>
                            ...
                            <p>Need a code template? Generate a prompt below, paste it into ChatGPT/Claude, and paste the code back here!</p>
                        </div>
                    </div>
                ...
                <form action="{{ route('mini-website-template.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="html_content" name="html_content" rows="15" style="font-family: monospace;" required></textarea>
                    </div>

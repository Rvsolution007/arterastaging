...
<div class="analytics-container">
    <div class="row align-items-center mb-4">
        <div class="col-md-12">
            <h4 class="page-title"><i class="fa-solid fa-pen-to-square mr-2 text-primary"></i> Update Sub Category</h4>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="premium-card">
                <div class="premium-card-header">
                    <h5 class="premium-card-title">Sub Category Details</h5>
                </div>
                <div class="premium-card-body">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group mb-4">
                                {!! Form::label('name','Sub Category Name', ['class' => 'form-label-premium']) !!}
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div id="preview">
                                    <img src="@if(App\Models\StorageSetting::getStorageSetting('storage') == 'DigitalOcean'){{\Storage::disk('spaces')->url('uploads/'.$category->icon)}} @else {{asset('uploads/'.$category->icon)}} @endif" 
                                         class="preview-box" alt="Sub Category Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-2">
                        ...
                        <button type="button" class="btn-premium ToastrButton">Update Sub Category</button>
                        @else
                        <button type="submit" class="btn-premium"><i class="fa-solid fa-cloud-arrow-up mr-2"></i> Update Sub Category</button>
                        @endif
                        <a href="{{ route('business-sub-category.index') }}" class="btn btn-link text-muted ml-3" style="font-weight: 500; font-size: 0.9rem; text-decoration: none;">Cancel</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>

...
<div class="analytics-container">
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h4 class="page-title mb-0"><i class="fa-solid fa-sitemap mr-2 text-primary"></i> Business Sub Categories</h4>
        </div>
        <div class="col-md-6 text-right">
            <a href="{{ route('business-sub-category.create')}}" class="btn-premium">
                <i class="fa-solid fa-plus mr-1"></i> Add New Sub Category
            </a>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="table-panel">
                <div class="table-panel-header">
                    <h5 class="table-panel-title">Sub Category Management</h5>
                    <span class="badge-soft">{{ count($data) }} Total Records</span>
                </div>
                    ...
                    <table class="custom-table" id="data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge-soft" style="background: #e0e7ff; color: #4338ca;">
                                        <i class="fa-solid fa-folder-tree mr-1"></i> {{ $row->business_category->name ?? 'N/A' }}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td class="text-right">
                                    <div class="d-flex align-items-center justify-content-end">
                                        <a href="{{url('admin/business-sub-category/'.$row->id.'/edit') }}" class="action-btn btn-edit mr-2" title="Edit">
                                    ...
                                    {!! Form::open(['url' => 'admin/business-sub-category/'.$row->id,'method'=>'DELETE','class'=>'d-none','id'=>'form_'.$row->id]) !!}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow" style="border-radius: 16px;">
            ...
            <div class="modal-body py-4">
                ...
                <p class="text-center text-muted mb-0">Are you sure you want to delete this sub category?</p>
            </div>

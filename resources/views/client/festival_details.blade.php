...
@section('styles')
    <style>
        ...
        .main-image-wrapper {
            ...
            max-width: 100%;
            max-height: 55vh;
            /* Remove hardcoded aspect-ratio: 4/5 */
            background-color: #ffffff;
            overflow: hidden;
            border-radius: 16px;
    ...
    <div class="selection-container">
        ...
        <div class="preview-section">
            <div class="main-image-wrapper">
                <img id="mainPreview" src="{{ asset('uploads/' . ($frames->first()->frame_image ?? $festival->image)) }}"
                    alt="Selected Design">
            </div>
        </div>
...
@section('scripts')
    <script>
        let selectedImage = "{{ asset('uploads/' . ($frames->first()->frame_image ?? $festival->image)) }}";
        ...
        function handleNext() {
            // Go to the editor page with the selected image
            window.location.href = "{{ route('festival.edit', $festival->id) }}?design=" + encodeURIComponent(selectedImage);
        }
        ...
        function downloadDesign() {
            ...
            link.download = 'festive_design.png';
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);

            trackWebDownload('festival', '{{ $festival->id }}', selectedImage);
        }

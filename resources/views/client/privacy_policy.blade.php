...
@section('content')
    <div class="fade-in bg-white min-h-screen pb-20">
        ...
        <div class="px-6 pt-10 pb-6 flex items-center gap-4">
            ...
            <h2 class="text-[22px] font-bold text-gray-900 tracking-tight">Privacy Policy</h2>
        </div>

        <div class="px-6 text-center mb-8">
            <div class="w-20 h-20 bg-indigo-50 rounded-3xl mx-auto flex items-center justify-center mb-4">
                <i data-lucide="shield-check" class="w-10 h-10 text-indigo-600"></i>
            </div>
            <p class="text-slate-500 text-sm px-6">Your privacy is important to us. Please read our policy carefully.</p>
        </div>

...
@section('title', 'Artera - Refund Policy')
...
@section('content')
    <div class="page-header">
        <div class="container">
            <h1 class="page-title" data-aos="fade-up">Refund Policy</h1>
            <p class="page-subtitle" data-aos="fade-up" data-aos-delay="100">Our refund policy ensures your satisfaction with our services.</p>
        </div>
    </div>

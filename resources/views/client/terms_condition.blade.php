...
@section('title', 'Artera - Terms & Conditions')
...
@section('content')
    <div class="page-header">
        <div class="container">
            <h1 class="page-title" data-aos="fade-up">Terms & Conditions</h1>
            <p class="page-subtitle" data-aos="fade-up" data-aos-delay="100">Please read our terms of service carefully before using the app.</p>
        </div>
    </div>

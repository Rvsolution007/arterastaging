    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex align-items-center mb-4">
                <a href="{{ route('festivals-post.index') }}" class="mr-3 text-muted" style="font-size: 1.2rem;"><i class="fa fa-arrow-left"></i></a>
            ...
            <div class="premium-card">
                ...
                <div class="card-body p-4">
                    ...
                    {!! Form::open(['route' => 'festivals-post.store', 'method' => 'post', 'files' => true, 'class' => 'poppins-font']) !!}

...
<div class="card card-success">
    ...
    <h3 class="card-title">Add Greeting Image</h3>
    </div>
    ...
    {!! Form::open(['route' => 'greeting.store','method'=>'post','files'=>true]) !!}
    {!! Form::hidden('user_id',optional(Auth::user())->id)!!}
    <input type="hidden" name="total" value="" id="total">
    <div class="row">
        <div class="col-12">
            <div class="form-group row">
                {!! Form::label('greeting_type','Greeting Type', ['class' => 'col-sm-3 col-form-label','placeholder'=>'Enter Name']) !!}
                <div class="col-sm-4">
    ...
    <!-- Removed early closing div to keep form inside card-body -->

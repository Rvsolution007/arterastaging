  ...
  <div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <a href="{{ route('greeting-category.create')}}" class="btn btn-success float-right">Add New</a>
        </div> 
            ...
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group text-center">
                    <a href="{{url('admin/greeting-category/'.$row->id.'/edit') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'admin/greeting-category/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
...
<script type="text/javascript">
    ...
    $(".status").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "{{url('admin/greeting-category-status')}}",
        data: { checked : checked , id : id},
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
        success: function(data) {
          new PNotify({
            title: 'Success!',
            text: "Greeting Category Status Has Been Changed.",
            type: 'success'
          });
        },
      });

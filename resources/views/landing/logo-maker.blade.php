...
@section('title', 'Artera - Logo Maker (Coming Soon)')
...
<section class="coming-soon-section">
    <div class="container">
        <div class="coming-soon-content">
            ...
            <h1>Instant Logo Maker</h1>
            <p>Create a professional, memorable logo for your business in seconds. Our AI-powered logo maker is currently under development.</p>

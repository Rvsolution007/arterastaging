            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 row">
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="req_address" class="form-control" value="0" min="0">
                    </div>
                    <div class="col-sm-3">
                        <label>Emails</label>
                        <input type="number" name="req_email" class="form-control" value="0" min="0">
                    </div>
                    <div class="col-sm-3">
                        <label>Phones</label>
                        <input type="number" name="req_phone" class="form-control" value="0" min="0">
                    </div>
                    <div class="col-sm-3">
                        <label>Websites</label>
                        <input type="number" name="req_website" class="form-control" value="0" min="0">
                    </div>
                </div>
            </div>
        </div>

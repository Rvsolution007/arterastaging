...
<div class="aim-container">
    <div class="aim-header">
        <div class="aim-header-left">
            <div class="aim-header-icon"><i class="fa-solid fa-box-open"></i></div>
            <div>
                <h2>Product Types</h2>
                <p>Manage the master list of Product Types</p>
            </div>
        </div>
        <div class="aim-header-right">
            ...
            <a href="{{ url('admin/product-type/create') }}" class="aim-btn aim-btn-primary">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div style="display: flex; gap: 8px; justify-content: flex-end;">
                                <a href="{{ url('admin/product-type/'.$row->id.'/edit') }}" class="action-btn btn-edit" title="Edit">
                            ...
                            <form action="{{ url('admin/product-type/'.$row->id) }}" method="POST" class="d-none" id="form_{{ $row->id }}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div style="color: #94a3b8; font-size: 1.1rem;">
                                <i class="fa fa-box-open mb-3" style="font-size: 2rem;"></i><br>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none;">
            <div class="modal-body" style="padding: 2rem; text-align: center;">
                ...
                <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 2rem;">Are you sure you want to delete <strong id="bulk_count_text">0</strong> product types? This action cannot be undone.</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none;">
            <div class="modal-body" style="padding: 2rem; text-align: center;">
                ...
                <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 2rem;">Are you sure you want to delete this product type?</p>
                <div style="display: flex; gap: 12px; justify-content: center;">
                    <button type="button" class="aim-btn" style="background: #f1f5f9; color: #475569;" data-dismiss="modal">Cancel</button>
                    @if(optional(Auth::user())->user_type == "Demo")
...
<div id="importModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('product-type.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Import Product Types</h5>
...
<script type="text/javascript">
    ...
    $('#export_btn').on('click', function(e) {
        ...
        var exportUrl = "{{ route('product-type.export') }}";
        if (query) {
    ...
    $('#confirm_bulk_delete').on('click', function() {
        ...
        $.ajax({
            url: "{{ url('admin/product-type/bulk-delete') }}",
            type: "POST",

        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="feature-card p-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        {!! Form::number('business_ai_generation_credit_cost', 1,['class' => 'form-control form-control-sm','required','min'=>1,'max'=>1000]) !!}
                    ...
                    @include('subscription._ai_image_access', ['subscription' => null, 'aiImageModels' => $aiImageModels])

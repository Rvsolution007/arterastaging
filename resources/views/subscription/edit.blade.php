...
@section('content')
                            ...
                            <div class="feature-card p-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-6">
                                        ...
                                        {!! Form::number('custom_post_edit_limit',$subscription->custom_post_edit_limit,['class' => 'form-control form-control-sm','required','min'=>0]) !!}
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="small text-muted font-weight-bold mb-1">Max Ad Uses</label>
                                        {!! Form::number('custom_post_ad_reward_limit', $subscription->custom_post_ad_reward_limit ?? 5, ['class' => 'form-control form-control-sm', 'min'=>0]) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="feature-card p-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-6">
                                        <label class="small text-muted font-weight-bold mb-1">Base Limit</label>
                                        {!! Form::number('daily_drip_limit',$subscription->daily_drip_limit,['class' => 'form-control form-control-sm','required','min'=>0]) !!}
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="small text-muted font-weight-bold mb-1">Max Ad Uses</label>
                                        {!! Form::number('daily_drip_ad_reward_limit', $subscription->daily_drip_ad_reward_limit ?? 5, ['class' => 'form-control form-control-sm', 'min'=>0]) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="feature-card p-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-6">
                                        <label class="small text-muted font-weight-bold mb-1">Base Limit</label>
                                        {!! Form::number('festival_post_limit', $subscription->festival_post_limit,['class' => 'form-control form-control-sm','required','min'=>0]) !!}
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="small text-muted font-weight-bold mb-1">Max Ad Uses</label>
                                        {!! Form::number('festival_post_ad_reward_limit', $subscription->festival_post_ad_reward_limit ?? 5, ['class' => 'form-control form-control-sm', 'min'=>0]) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row mt-4 mb-5 pb-5">
        ...
        <button type="button" class="btn btn-primary btn-lg px-5 py-3 shadow-sm rounded-pill font-weight-bold ToastrButton">Update Subscription Plan</button>
        @else
        {!! Form::submit('Update Subscription Plan', ['class' => 'btn btn-primary btn-lg px-5 py-3 shadow-sm rounded-pill font-weight-bold']) !!}
        @endif
        </div>
    </div>
    {!! Form::close() !!}
